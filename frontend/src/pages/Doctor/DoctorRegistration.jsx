...
console.log(cloudImage);
  ...
  const handleFileChange =async () => {
    ...
    setIsLoading(true)
    axios.post('https://api.cloudinary.com/v1_1/da090dgs3/image/upload',formData).then((data)=>{
            ...
            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
              <div className="text-gray-600">
                ...
                <img
                  ...
                  alt=""
                />
                { isLoading ? <CircleLoader color="#0000ff" size={20} className="ml-12 py-2 px-4" /> :( <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ml-4"
