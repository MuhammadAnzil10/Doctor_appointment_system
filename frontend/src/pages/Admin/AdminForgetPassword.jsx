...
import { useAdminForgetPasswordMutation } from "../../AdminSlices/adminApiSlice.js";

const AdminForgetPassword = () => {
  const [email, setEmail] = useState("");
  const [AdminForgetPassword, { isLoading }] = useAdminForgetPasswordMutation();
